...
from app import db
from flask import g, flash, redirect, url_for, request, current_app, render_template, jsonify
...
def before_request():
    ...
    g.locale = 'zh-tw' if str(get_locale()).startswith('zh') else str(get_locale())
